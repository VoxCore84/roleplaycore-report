...
This website. A static site generator with dark arcane theme, built from Markdown sources by a Python script. Outputs to GitHub Pages.
...
|---|---|---|
| Wago Tooling | 75+ scripts — TACT extractor, CSV merger, hotfix repair, ATT mega-parser, MCP server, build differ, redundancy audit | Python |
...
| [Session Changelog](https://gist.github.com/VoxCore84/4c63baf8154753d2a89475d9a4f5b2cc) | Chronological log of all 64+ development sessions with commit hashes |
...
| Tool | What it does |
|---|---|
| WowPacketParser | Packet capture decoder, locally patched for build 66263 |
...
| Ymir | Retail packet sniffer for build 66263 |
