...
|---|---|---|
| `repair_hotfix_tables.py` | Python | Compares all 388 hotfix tables against Wago DB2 CSVs, generates repair SQL in 5 batches |
| `wago_db2_downloader.py` | Python | Threaded CSV downloader for 1,097 DB2 tables from Wago.tools |
...
| `quest_chain_gen.py` | Python | Generates 21,758 PrevQuestID/NextQuestID chain links |
...
| `att_parser.py` | Python | Full Lua tokenizer for the AllTheThings database (1,576 files, 47K quests) |
...
| TACTSharp | C# | Blizzard CASC storage extraction library |
